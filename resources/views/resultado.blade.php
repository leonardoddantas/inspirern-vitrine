        ...
        <div class="relative z-10 container mx-auto px-4 h-full">
            ...
            <section>
                <div class="flex flex-row space-x-5 mb-5">
                    <div class="w-1/4">
                        <img src="{{asset('img/mapa.jpg')}}" alt="Mapa do local pesquisado" class="rounded shadow-md w-full">
                    </div>
                    <div class="w-3/4">
                ...
                <div class="flex flex-row items-start space-x-5">
                    <div class="w-1/4 p-4 bg-gray-100 rounded shadow-md">
                        ...
                        <div class="mb-4">
                            <h4 class="mb-2 text-lg">Tipo de propriedade</h4>
                            <div class="mb-1">
                                <input type="radio" name="property_type" id="casa" value="casa" class="mr-2">
                                <label for="casa" class="text-gray-800">Casa</label>
                            </div>
                            <div class="mb-1">
                                <input type="radio" name="property_type" id="apartamento" value="apartamento" class="mr-2">
                                <label for="apartamento" class="text-gray-800">Apartamento</label>
                            </div>
                            <div class="mb-1">
                                <input type="radio" name="property_type" id="hotel" value="hotel" class="mr-2">
                                <label for="hotel" class="text-gray-800">Hotel</label>
                            </div>
                            <div>
                                <input type="radio" name="property_type" id="pousada" value="pousada" class="mr-2">
                       ...
                       <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-1">
                                <input type="radio" name="num_rooms" id="um_quarto" value="1" class="mr-2">
                                <label for="um_quarto" class="text-gray-800">1 Quarto</label>
                            </div>
                            <div class="mb-1">
                                <input type="radio" name="num_rooms" id="dois_quartos" value="2" class="mr-2">
                                <label for="dois_quartos" class="text-gray-800">2 Quartos</label>
                            </div>
                            <div class="mb-1">
                                <input type="radio" name="num_rooms" id="tres_quartos" value="3" class="mr-2">
                                <label for="tres_quartos" class="text-gray-800">3 Quartos</label>
                            </div>
                            <div>
                                <input type="radio" name="num_rooms" id="quatro_ou_mais" value="4+" class="mr-2">
                                <label for="quatro_ou_mais" class="text-gray-800">4 ou mais Quartos</label>
                            </div>
                        </div>
                        <div class="mb-4">
                            <h4 class="mb-2 text-lg">Comodidades</h4>
                            <div class="mb-1">
                                <input type="checkbox" name="amenities" id="wifi" value="wifi" class="mr-2">
                                <label for="wifi" class="text-gray-800">Wi-Fi</label>
                            </div>
                            <div class="mb-1">
                                <input type="checkbox" name="amenities" id="piscina" value="piscina" class="mr-2">
                                <label for="piscina" class="text-gray-800">Piscina</label>
                            </div>
                            <div class="mb-1">
                                <input type="checkbox" name="amenities" id="estacionamento" value="estacionamento" class="mr-2">
                                <label for="estacionamento" class="text-gray-800">Estacionamento</label>
                            </div>
                            <div>
                                <input type="checkbox" name="amenities" id="academia" value="academia" class="mr-2">
                                <label for="academia" class="text-gray-800">Academia</label>
                            </div>
                        </div>
                        <div class="mb-4">
                            <h4 class="mb-2 text-lg">Classificação</h4>
                            <div class="mb-1">
                                <input type="radio" name="rating" id="cinco_estrelas" value="5" class="mr-2">
                                <label for="cinco_estrelas" class="text-gray-800">5 Estrelas</label>
                            </div>
                            <div class="mb-1">
                                <input type="radio" name="rating" id="quatro_estrelas" value="4" class="mr-2">
                                <label for="quatro_estrelas" class="text-gray-800">4 Estrelas</label>
                            </div>
                            <div class="mb-1">
                                <input type="radio" name="rating" id="tres_estrelas" value="3" class="mr-2">
                    ...
                    <div class="w-3/4 flex flex-col items-center justify-center space-y-5">
                        <div class="flex flex-row p-4 space-x-5 bg-gray-100 rounded shadow-md hover:bg-blue-950 hover:text-gray-50 hover:shadow-lg transform hover:scale-105 transition">
                            <div class="w-3/4 space-y-1 tracking-wide">
                                <h3 class="mb-2 text-xl font-medium">Nome do Local</h3>
                                <p>Endereço: Avenida Praia de Ponta Negra, Natal, RN</p>
                                <p>Horário de Visita: 09:00 - 12:00</p>
                                <p>Descrição: Uma das praias mais famosas de Natal, conhecida pelo Morro do Careca. Uma  das praias mais famosas de Natal, conhecida.</p>
                            </div>
                            <div class="w-1/4">
                                <img src="{{asset('img/natal-setion-where-are-we-go.jpg')}}" alt="Imagem do local" class="w-full h-full rounded shadow-md">
                            </div>
                        </div>
                        <div class="flex flex-row p-4 space-x-5 bg-gray-100 rounded shadow-md hover:bg-blue-950 hover:text-gray-50 hover:shadow-lg transform hover:scale-105 transition">
                            <div class="w-3/4 space-y-1 tracking-wide">
